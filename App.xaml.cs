...
namespace AmecFWUPI
{
    sealed partial class App
    {
        ...
        async public void initializeDB()
        {
            ...
            await _database.dbCreateTableLoginInfoAsync();
            //await _database.dbInsertTableLoginInfoAsync("shah", "shah");
            await App._database.dbCreateTablePoleInfoAsync();
            //await _database.dbCreateTableAddPoleTasksAsync();
        }
        public static Task<string> _database1 { get; internal set; }
