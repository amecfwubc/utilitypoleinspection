...
namespace AmecFWUPI
{
    public sealed partial class MainPage
    {
        ...
        //A method to navigate to the AddPoleInfoTasks page
        private void btnAddPoleInfo_Click(object sender, RoutedEventArgs e)
        {
            MetroEventSource.Log.Debug("Initializing the AddPoleInfoTasks Page");
            this.Frame.Navigate(typeof(AddPoleInfoTasks));
        ...
        {
            this.Frame.Navigate(typeof(ServerData));
        }
    }
}
